...
obesity <- read.csv("clean_obesity_data.csv")
head(obesity)
...
```{r, echo=FALSE}
hist(obesity$Prevalence, main = "Histogram of Adult Obesity Rate by State", xlab = "Obesity (in percentage)")
mean_obesity <- mean(obesity$Prevalence, na.rm = TRUE)
median_obesity <- median(obesity$Prevalence, na.rm = TRUE)
sd_obesity <- sd(obesity$Prevalence, na.rm = TRUE)
